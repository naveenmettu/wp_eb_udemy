...
<div class="container">
  <div class="middle-align">
    <?php
        $theme_lay = get_theme_mod( 'vw_blog_magazine_theme_options','One Column');
        if($theme_lay == 'Left Sidebar'){ ?>
        <div class="col-md-3 col-sm-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
        <section id="our-services" class="services col-md-9 col-sm-9">
    ...
    <?php }else if($theme_lay == 'Grid Layout'){ ?>
        <section id="our-services" class="services col-md-9">
